...
public class ClassifierOther extends Classifier {
	...
	//group divisions
	public int numAgeGroups = 10;
	public int numCapGainsGroups = 10;
	public int numCapLossesGroups = 10;
	public int numHoursWorkedGroups = 10;
	...
	public ClassifierOther(String namesFilePath) {
		super(namesFilePath);
